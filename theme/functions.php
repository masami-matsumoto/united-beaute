...
function my_enqueue_scripts() {
	...
	wp_enqueue_script( 'script-name', get_template_directory_uri(). '/js/script.js', array() );
	wp_enqueue_script( 'script-name', get_template_directory_uri(). '/js/swiper-bundle.min.js', array() );
	wp_enqueue_style( 'style-name', get_template_directory_uri(). '/css/common.css', array() );
	wp_enqueue_style( 'style-name', get_template_directory_uri(). '/css/styles.css', array() );
	wp_enqueue_style( 'style-name', get_template_directory_uri(). '/css/swiper.min.css', array() );
	wp_enqueue_style( 'style-name', get_template_directory_uri(). '/css/swiper-bundle.min.css', array() );
}
